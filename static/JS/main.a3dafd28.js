const App = {
  ...
  async init() {
    ...
    this.root.innerHTML = '<div class="app-shell"><div class="top-panel"><h1>Mirage Crafting Sheet</h1><div class="subtitle">made by Charlie Brown - UID 442</div><div id="app-controls"></div></div><div id="recipe-list"></div></div>';
